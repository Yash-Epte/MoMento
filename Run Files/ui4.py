...
# ── Header ────────────────────────────────────────────────────────────────────
st.markdown('<div class="page-title">Meeting Transcriber</div>', unsafe_allow_html=True)
st.markdown('<div class="page-subtitle">Upload a meeting recording to extract tasks and action items per person.</div>', unsafe_allow_html=True)

# ── Upload & Transcribe ───────────────────────────────────────────────────────
audio_file = st.file_uploader("Upload Audio File", type=["mp3", "wav", "mp4", "m4a", "ogg", "webm"])
...
if people:
    ...
    # Filter people by name or task content
